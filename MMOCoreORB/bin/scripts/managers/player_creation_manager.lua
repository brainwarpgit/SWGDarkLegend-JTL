...
travelBag = "object/tangible/wearables/backpack/backpack_s01.iff"
...
commonStartingItems = { marojMelon, survivalKnife, SwoopBike, travelBag, brawlerOneHander, brawlerTwoHander, brawlerPolearm, marksmanPistol, marksmanCarbine, marksmanRifle, genericTool, mineralTool, chemicalTool, foodTool, gasTool }
