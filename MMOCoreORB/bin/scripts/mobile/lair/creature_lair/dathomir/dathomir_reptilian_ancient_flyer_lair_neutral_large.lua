dathomir_reptilian_ancient_flyer_lair_neutral_large = Lair:new {
	mobiles = {{"ancient_reptilian_flier",15},{"ancient_reptilian_flier_elite",5},{"ancient_reptilian_flier_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("dathomir_reptilian_ancient_flyer_lair_neutral_large", dathomir_reptilian_ancient_flyer_lair_neutral_large)
