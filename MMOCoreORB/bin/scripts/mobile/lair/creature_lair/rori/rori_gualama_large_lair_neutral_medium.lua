rori_gualama_large_lair_neutral_medium = Lair:new {
	mobiles = {{"mobiles=maverick_gualama",15},{"mobiles=maverick_gualama_elite",5},{"mobiles=maverick_gualama_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("rori_gualama_large_lair_neutral_medium", rori_gualama_large_lair_neutral_medium)
