corellia_wrix_lair_neutral_medium = Lair:new {
	mobiles = {{"wrix",15},{"wrix_elite",5},{"wrix_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_wrix_lair_neutral_medium", corellia_wrix_lair_neutral_medium)
