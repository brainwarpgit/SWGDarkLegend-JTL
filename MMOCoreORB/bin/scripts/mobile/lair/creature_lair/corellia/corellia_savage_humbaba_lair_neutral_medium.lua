corellia_savage_humbaba_lair_neutral_medium = Lair:new {
	mobiles = {{"mobiles=savage_humbaba",15},{"mobiles=savage_humbaba_elite",5},{"mobiles=savage_humbaba_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_savage_humbaba_lair_neutral_medium", corellia_savage_humbaba_lair_neutral_medium)
