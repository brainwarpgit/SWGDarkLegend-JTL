tatooine_swarming_lesser_dewback_lair_neutral_large = Lair:new {
	mobiles = {{"mobiles=swarming_lesser_dewback",15},{"mobiles=swarming_lesser_dewback_elite",5},{"mobiles=swarming_lesser_dewback_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("tatooine_swarming_lesser_dewback_lair_neutral_large", tatooine_swarming_lesser_dewback_lair_neutral_large)
