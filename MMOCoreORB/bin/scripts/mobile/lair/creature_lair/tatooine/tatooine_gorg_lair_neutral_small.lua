tatooine_gorg_lair_neutral_small = Lair:new {
	mobiles = {{"gorg",15},{"gorg_elite",5},{"gorg_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("tatooine_gorg_lair_neutral_small", tatooine_gorg_lair_neutral_small)
