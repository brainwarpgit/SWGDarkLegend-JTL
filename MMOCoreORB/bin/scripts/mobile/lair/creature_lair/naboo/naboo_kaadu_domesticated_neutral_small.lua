naboo_kaadu_domesticated_neutral_small = Lair:new {
	mobiles = {{"motley_kaadu",15},{"motley_kaadu_elite",5},{"motley_kaadu_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("naboo_kaadu_domesticated_neutral_small", naboo_kaadu_domesticated_neutral_small)
