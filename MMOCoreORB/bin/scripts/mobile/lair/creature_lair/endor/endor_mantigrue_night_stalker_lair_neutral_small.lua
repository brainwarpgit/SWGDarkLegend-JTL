endor_mantigrue_night_stalker_lair_neutral_small = Lair:new {
	mobiles = {{"mantigrue_night_stalker",15},{"mantigrue_night_stalker_elite",5},{"mantigrue_night_stalker_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_mantigrue_night_stalker_lair_neutral_small", endor_mantigrue_night_stalker_lair_neutral_small)
