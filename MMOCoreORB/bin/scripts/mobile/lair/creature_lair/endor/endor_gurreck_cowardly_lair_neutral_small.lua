endor_gurreck_cowardly_lair_neutral_small = Lair:new {
	mobiles = {{"mobiles=cowardly_gurreck",15},{"mobiles=cowardly_gurreck_elite",5},{"mobiles=cowardly_gurreck_heroic",1}},
	spawnLimit = 15,
