endor_bounding_jax_lair_neutral_small = Lair:new {
	mobiles = {{"bounding_jax",15},{"bounding_jax_elite",5},{"bounding_jax_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_bounding_jax_lair_neutral_small", endor_bounding_jax_lair_neutral_small)
