endor_boar_wolf_bloodfrenzied_lair_neutral_small = Lair:new {
	mobiles = {{"blood_frenzied_boar_wolf",15},{"blood_frenzied_boar_wolf_elite",5},{"blood_frenzied_boar_wolf_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_boar_wolf_bloodfrenzied_lair_neutral_small", endor_boar_wolf_bloodfrenzied_lair_neutral_small)
