talus_famished_sludge_panther_lair_neutral_mdium = Lair:new {
	mobiles = {{"famished_sludge_panther",15},{"famished_sludge_panther_elite",5},{"famished_sludge_panther_heroic",1}},
	spawnLimit = 15,
...
addLairTemplate("talus_famished_sludge_panther_lair_neutral_mdium", talus_famished_sludge_panther_lair_neutral_mdium)
