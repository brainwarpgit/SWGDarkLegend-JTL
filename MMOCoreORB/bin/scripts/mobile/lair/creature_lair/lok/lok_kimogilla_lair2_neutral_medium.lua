lok_kimogilla_lair2_neutral_medium = Lair:new {
	mobiles = {{"kimogila",30},{"kimogila_elite",10},{"kimogila_heroic",2},{"enraged_kimogila",15},{"enraged_kimogila_elite",5},{"enraged_kimogila_heroic",1},{"kimogila_hatchling",30},{"kimogila_hatchling_elite",10},{"kimogila_hatchling_heroic",2}},
	spawnLimit = 7,
...
addLairTemplate("lok_kimogilla_lair2_neutral_medium", lok_kimogilla_lair2_neutral_medium)
