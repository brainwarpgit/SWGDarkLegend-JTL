dantooine_abandoned_rebel_camp_rebel_small_theater = Lair:new {
	mobiles = {{"mobiles=abandoned_rebel_private",15},{"mobiles=abandoned_rebel_private_elite",5},{"mobiles=abandoned_rebel_private_heroic",1},{"stranded_rebel_scout",15},{"stranded_rebel_scout_elite",5},{"stranded_rebel_scout_heroic",1}},
	spawnLimit = 15,
