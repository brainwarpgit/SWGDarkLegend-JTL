dathomir_escaped_mtn_clan_slave_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"mobiles=escaped_singing_mountain_clan_slave",15},{"mobiles=escaped_singing_mountain_clan_slave_elite",5},{"mobiles=escaped_singing_mountain_clan_slave_heroic",1},{"domesticated_brackaset",15},{"domesticated_brackaset_elite",5},{"domesticated_brackaset_heroic",1}},
	spawnLimit = 12,
...
addLairTemplate("dathomir_escaped_mtn_clan_slave_camp_neutral_medium_theater", dathomir_escaped_mtn_clan_slave_camp_neutral_medium_theater)
