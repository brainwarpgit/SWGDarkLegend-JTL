...
naboo_gungan_mercenary_camp_neutral_large_theater = Lair:new {
	mobiles = {{"gungan_mercenary",30},{"gungan_mercenary_elite",10},{"gungan_mercenary_heroic",2},{"gungan_kaadu",15},{"gungan_kaadu_elite",5},{"gungan_kaadu_heroic",1},{"gungan_kaadu_rider",15},{"gungan_kaadu_rider_elite",5},{"gungan_kaadu_rider_heroic",1}},
	spawnLimit = 15,
