tatooine_imperial_camp = Lair:new {
	mobiles = {{"mobiles=sand_trooper",45},{"mobiles=sand_trooper_elite",15},{"mobiles=sand_trooper_heroic",3},{"stormtrooper_dewback",15},{"stormtrooper_dewback_elite",5},{"stormtrooper_dewback_heroic",1}},
	spawnLimit = 9,
