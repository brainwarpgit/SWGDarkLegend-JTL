tatooine_jabba_camp = Lair:new {
	mobiles = {{"mobiles=jabba_enforcer",15},{"mobiles=jabba_enforcer_elite",5},{"mobiles=jabba_enforcer_heroic",1},{"jabba_swooper",15},{"jabba_swooper_elite",5},{"jabba_swooper_heroic",1},{"jabba_assassin",15},{"jabba_assassin_elite",5},{"jabba_assassin_heroic",1}},
	spawnLimit = 12,
