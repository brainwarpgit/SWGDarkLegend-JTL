tatooine_jabba_enforcer_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"jabba_enforcer",15},{"jabba_enforcer_elite",5},{"jabba_enforcer_heroic",1}},
	spawnLimit = 12,
...
addLairTemplate("tatooine_jabba_enforcer_camp_neutral_medium_theater", tatooine_jabba_enforcer_camp_neutral_medium_theater)
