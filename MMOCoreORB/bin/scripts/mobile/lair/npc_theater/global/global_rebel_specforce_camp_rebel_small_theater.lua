global_rebel_specforce_camp_rebel_small_theater = Lair:new {
	mobiles = {{"mobiles=specforce_wilderness_operative",60},{"mobiles=specforce_wilderness_operative_elite",20},{"mobiles=specforce_wilderness_operative_heroic",4},{"senior_specforce_wilderness_scout",15},{"senior_specforce_wilderness_scout_elite",5},{"senior_specforce_wilderness_scout_heroic",1},{"senior_specforce_wilderness_fighter",15},{"senior_specforce_wilderness_fighter_elite",5},{"senior_specforce_wilderness_fighter_heroic",1}},
	spawnLimit = 9,
