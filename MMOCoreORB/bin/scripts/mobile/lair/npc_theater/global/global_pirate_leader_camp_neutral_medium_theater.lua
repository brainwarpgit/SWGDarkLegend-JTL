global_pirate_leader_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"pirate_leader",15},{"pirate_leader_elite",5},{"pirate_leader_heroic",1}},
	spawnLimit = 12,
...
addLairTemplate("global_pirate_leader_camp_neutral_medium_theater", global_pirate_leader_camp_neutral_medium_theater)
