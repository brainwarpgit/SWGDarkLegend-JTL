global_bothan_diplomat_camp_neutral_small_theater = Lair:new {
	mobiles = {{"bothan_diplomat",15},{"bothan_diplomat_elite",5},{"bothan_diplomat_heroic",1}},
	spawnLimit = 9,
...
addLairTemplate("global_bothan_diplomat_camp_neutral_small_theater", global_bothan_diplomat_camp_neutral_small_theater)
