global_rebel_creature_handler_apprentice_huurton_camp_rebel_small_theater = Lair:new {
	mobiles = {{"apprentice_creature_handler",15},{"apprentice_creature_handler_elite",5},{"apprentice_creature_handler_heroic",1},{"tamed_huurton",45},{"tamed_huurton_elite",15},{"tamed_huurton_heroic",3}},
	spawnLimit = 9,
