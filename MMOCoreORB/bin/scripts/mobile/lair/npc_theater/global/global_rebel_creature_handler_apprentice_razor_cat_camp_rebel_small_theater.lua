global_rebel_creature_handler_apprentice_razor_cat_camp_rebel_small_theater = Lair:new {
	mobiles = {{"apprentice_creature_handler",15},{"apprentice_creature_handler_elite",5},{"apprentice_creature_handler_heroic",1},{"tamed_razor_cat",45},{"tamed_razor_cat_elite",15},{"tamed_razor_cat_heroic",3}},
	spawnLimit = 9,
