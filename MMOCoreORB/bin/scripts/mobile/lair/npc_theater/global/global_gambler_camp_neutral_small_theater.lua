global_gambler_camp_neutral_small_theater = Lair:new {
	mobiles = {{"gambler",15},{"gambler_elite",5},{"gambler_heroic",1}},
	spawnLimit = 9,
...
addLairTemplate("global_gambler_camp_neutral_small_theater", global_gambler_camp_neutral_small_theater)
