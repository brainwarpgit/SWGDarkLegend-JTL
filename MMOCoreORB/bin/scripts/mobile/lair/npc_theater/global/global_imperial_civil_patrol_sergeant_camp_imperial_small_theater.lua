global_imperial_civil_patrol_sergeant_camp_imperial_small_theater = Lair:new {
	mobiles = {{"mobiles=civil_patrol_sergeant",15},{"mobiles=civil_patrol_sergeant_elite",5},{"mobiles=civil_patrol_sergeant_heroic",1},{"civil_patrol_corporal",45},{"civil_patrol_corporal_elite",15},{"civil_patrol_corporal_heroic",3}},
	spawnLimit = 9,
