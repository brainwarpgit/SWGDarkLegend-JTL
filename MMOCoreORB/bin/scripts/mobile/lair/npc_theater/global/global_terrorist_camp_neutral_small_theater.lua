global_terrorist_camp_neutral_small_theater = Lair:new {
	mobiles = {{"mobiles=terrorist",15},{"mobiles=terrorist_elite",5},{"mobiles=terrorist_heroic",1}},
	spawnLimit = 9,
...
addLairTemplate("global_terrorist_camp_neutral_small_theater", global_terrorist_camp_neutral_small_theater)
