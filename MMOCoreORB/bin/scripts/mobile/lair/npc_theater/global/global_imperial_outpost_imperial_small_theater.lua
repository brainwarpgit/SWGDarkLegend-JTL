global_imperial_outpost_imperial_small_theater = Lair:new {
	mobiles = {{"imperial_second_lieutenant",15},{"imperial_second_lieutenant_elite",5},{"imperial_second_lieutenant_heroic",1},{"imperial_private",30},{"imperial_private_elite",10},{"imperial_private_heroic",2}},
	spawnLimit = 9,
