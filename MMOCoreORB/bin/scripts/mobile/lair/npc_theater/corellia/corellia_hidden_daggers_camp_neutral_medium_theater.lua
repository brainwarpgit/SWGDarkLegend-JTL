corellia_hidden_daggers_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"hidden_daggers_dissident",15},{"hidden_daggers_dissident_elite",5},{"hidden_daggers_dissident_heroic",1},{"hidden_daggers_activist",15},{"hidden_daggers_activist_elite",5},{"hidden_daggers_activist_heroic",1}},
	spawnLimit = 15,
