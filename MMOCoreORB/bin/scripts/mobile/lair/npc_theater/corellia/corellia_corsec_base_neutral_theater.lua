corellia_corsec_base_neutral_theater = Lair:new {
	mobiles = {{"mobiles=corsec_commissioner",15},{"mobiles=corsec_commissioner_elite",5},{"mobiles=corsec_commissioner_heroic",1},{"corsec_chief",30},{"corsec_chief_elite",10},{"corsec_chief_heroic",2}},
	spawnLimit = 15,
