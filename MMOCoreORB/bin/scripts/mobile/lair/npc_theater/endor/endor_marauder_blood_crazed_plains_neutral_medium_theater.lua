endor_marauder_blood_crazed_plains_neutral_medium_theater = Lair:new {
	mobiles = {{"mobiles=blood_crazed_plains_marauder",15},{"mobiles=blood_crazed_plains_marauder_elite",5},{"mobiles=blood_crazed_plains_marauder_heroic",1},{"berserk_marauder",15},{"berserk_marauder_elite",5},{"berserk_marauder_heroic",1}},
	spawnLimit = 12,
