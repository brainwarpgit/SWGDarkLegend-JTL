rori_cobral_overlord_camp_neutral_large_theater = Lair:new {
	mobiles = {{"mobiles=neo_cobral_overlord",15},{"mobiles=neo_cobral_overlord_elite",5},{"mobiles=neo_cobral_overlord_heroic",1},{"neo_cobral_hitman",15},{"neo_cobral_hitman_elite",5},{"neo_cobral_hitman_heroic",1}},
	spawnLimit = 12,
