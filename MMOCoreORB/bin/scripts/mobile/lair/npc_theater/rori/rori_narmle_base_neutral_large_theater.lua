rori_narmle_base_neutral_large_theater = Lair:new {
	mobiles = {{"narmle_militia_colonel",15},{"narmle_militia_colonel_elite",5},{"narmle_militia_colonel_heroic",1},{"narmle_militia_commander",15},{"narmle_militia_commander_elite",5},{"narmle_militia_commander_heroic",1}},
	spawnLimit = 15,
