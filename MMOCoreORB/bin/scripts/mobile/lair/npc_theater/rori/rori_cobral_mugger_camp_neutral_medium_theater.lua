rori_cobral_mugger_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"mobiles=cobral_mugger",15},{"mobiles=cobral_mugger_elite",5},{"mobiles=cobral_mugger_heroic",1},{"cobral_hooligan",15},{"cobral_hooligan_elite",5},{"cobral_hooligan_heroic",1}},
	spawnLimit = 12,
