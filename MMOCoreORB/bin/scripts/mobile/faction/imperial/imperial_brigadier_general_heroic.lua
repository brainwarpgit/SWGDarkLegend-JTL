imperial_brigadier_general = Creature:new {
	...
	primaryAttacks = merge(pistoleermaster,marksmanmaster),
	secondaryAttacks = merge(carbineermaster,marksmanmaster)
}

CreatureTemplates:addCreatureTemplate(imperial_brigadier_general, "imperial_brigadier_general_heroic")
