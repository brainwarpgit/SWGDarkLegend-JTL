fbase_imperial_master_sergeant = Creature:new {
	objectName = "@mob/creature_names:fbase_imperial_master_sergeant",
...
CreatureTemplates:addCreatureTemplate(fbase_imperial_master_sergeant, "fbase_imperial_master_sergeant_heroic")
